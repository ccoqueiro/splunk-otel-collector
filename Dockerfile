...
FROM alpine:3.15.0 AS smartagent
...
FROM debian:11.2 as journalctl
RUN apt update
...
COPY --chown=999 config/collector/splunk-otel-collector.conf /etc/otel/collector/splunk-otel-collector.conf
